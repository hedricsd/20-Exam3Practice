...
def hourglass(window, n, point, radius, color):
    ...
    for k in range(n):
        for j in range(k+1):
            ...
            line1 = rg.Line(rg.Point(circ1.center.x - radius, circ1.center.y), rg.Point(circ1.center.x + radius, circ1.center.y))
            line2 = rg.Line(rg.Point(circ2.center.x - radius, circ2.center.y), rg.Point(circ2.center.x + radius, circ2.center.y))
            line1.attach_to(window)
